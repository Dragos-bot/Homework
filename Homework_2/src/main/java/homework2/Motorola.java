...
public class Motorola extends Phone implements IPhoneManager{
    ...
    public Motorola(String name, ArrayList<Contact> contacts, String color) {
        this.name = name;
        this.contacts = contacts;
        this.color = color;
    }

    public Motorola(String name, String color) {
        this.name = name;
        this.color = color;
